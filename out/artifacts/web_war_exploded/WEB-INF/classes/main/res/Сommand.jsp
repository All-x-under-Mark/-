        ...
        <div class="content-white">
            ...
            <aside>
                ...
                <ul class="menu">
                    ...
                    <li><a href="../../../web/index.jsp">Головна</a></li>
                    <li class="current"><span>Команда</span></li>
                    <li><a href="../../../web/Table.jsp">Таблиця</a> <br></li>
                    <li><a href="../../../web/History.jsp">Історія</a> <br></li>
                    <li><a href="../../../web/PhotoGallery.jsp">Фотогалерея</a> <br></li>
                    <li><a href="../../../web/Achievements.jsp">Досягнення</a></li>
