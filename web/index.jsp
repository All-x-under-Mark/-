<%@ page import="main.dao.BooksEntity" %>
<%@ page import="org.hibernate.Session" %>
<%@ page import="main.dao.util.HibernateSessionFactory" %><%-- Created by IntelliJ IDEA. --%>
            ...
            <aside>
                ...
                <div class="interest">
                    ...
                    <div class="container-submit">
                                        <span>
<%--                                        <button type="submit" name="submitReg" formtarget="_self"--%>
<%--                                                autofocus>Регістрація</button>--%>
<%--                                        <button type="submit" name="submitLog" formtarget="_self"--%>
<%--                                                autofocus>Логін</button>--%>
                ...
                <ul class="menu">
                    ...
                    <li class="current"><span>Головна</span></li>
